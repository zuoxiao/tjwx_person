...
import com.example.tjwx_person.tool.DownLoadDialog.ICallbackResult;
...
public class DownloadService extends Service {
	...
	/* 下载包安装路径 */
	private static final String savePath = "/sdcard/bjyl_updateApkDemo/";

	private static final String saveFileName = savePath + "bjyl_App.apk";
	private ICallbackResult callback;
	private DownloadBinder binder;
	private Application app;
	private boolean serviceIsDestroy = false;
	private Application ismust;
...
//						serviceIsDestroy = true;
	...
	public void onCreate() {
		// TODO Auto-generated method stub
		super.onCreate();
		ismust=(Application) getApplication();
	...
	private void setUpNotification() {
		...
		contentView.setTextViewText(R.id.name, "我来修修apk正在下载...");
		// 指定个性化视图
