...
import com.example.tjwx_person.activity.EmergencyRepairActivity;
import com.example.tjwx_person.activity.RepairActivity;
import com.example.tjwx_person.adapter.Repair_TypeAdapter.ViewHolder;
import com.example.tjwx_person.bean.TypeData;
import com.example.tjwx_person.bean.skillData;

public class EmergencyRepair_TypeAdapter extends BaseAdapter {
	...
	public EmergencyRepair_TypeAdapter(Context context, List<skillData> list,
			HashMap<Integer, Boolean> isSelected) {
