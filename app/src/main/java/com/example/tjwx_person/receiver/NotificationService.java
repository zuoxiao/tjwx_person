...
public class NotificationService {
    ...
    public void save(XGNotification notification) {
        ...
        values.put("notifactionId", notification.getNotifactionId());
    ...
    public List<XGNotification> getScrollData(int currentPage, int lineSize,
        ...
        try {
            if (msg_id == null || "".equals(msg_id)) {
                cursor = db
                        .query("notification",
                                new String[]{"id,msg_id,title,content,activity,notificationActionType,update_time,notifactionId"},
